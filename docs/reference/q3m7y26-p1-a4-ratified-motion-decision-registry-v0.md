...
| `A4-D5-006` | `REPAIR_SOURCE_HEAD` | `Q3M7Y26-P1:D5R3` | `JAI::DEV::BUILDER` | `CT-2026-07-21-Q3M7Y26-P1-D5R3-TEST-EVIDENCE-CLOSURE-v0` | [D5R3-HEAD], [PR386] | `5 repository source + 8 mirror-only token text` | Adds coordinated false-evidence rejection tests. | `STATIC_CONFIGURATION` | Repository repair head; token appears only in PR metadata and establishes no authority. |
